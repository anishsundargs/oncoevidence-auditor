...
# Patch app.py to import and render feature strip after the hero.
...
if "render_feature_strip()" not in text:
    text = text.replace("render_hero()", "render_hero()\nrender_feature_strip()", 1)

app_path.write_text(text)

print("Enhanced UI visual design and fixed dark selectbox readability.")