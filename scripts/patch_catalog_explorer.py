...
page_path = Path("pages/4_Catalog_Explorer.py")
...
if readiness_path.exists():
    ...
    entry = '    "pages/4_Catalog_Explorer.py",\n'
...
"""
    if "## Catalog explorer" not in readme:
        readme_path.write_text(readme.rstrip() + "\\n\\n" + section.strip() + "\\n")


print("Added Catalog Explorer page and updated readiness/README references.")